          ...
          <form class="js-validate" action="precios.php" method="post">
            <div class="row fieldGroup">
              ...
              <div class="col-lg-2 align-self-lg-end" id="add1">
                <a href="javascript:void(0);"  data-balloon-visible data-balloon="¡Agregar Familiares!" data-balloon-pos="up" class="btn btn-block btn-success u-btn-success transition-3d-hover btn-addform addMore" title="Add field"> Añadir</a>
            ...
            <div class="row" style="display:none;">
              <div class="fieldGroupCopy">
                ...
                <div class="col-lg-2 align-self-lg-end" id="add1">
               <a href="javascript:void(0);" class="btn btn-block btn-success u-btn-success transition-3d-hover btn-addform remove" title="Add field"> <i class="fas fa-trash-alt"></i></a> 
              </div>  
            </div>
    ...
    <div class="container u-space-1-top u-space-1-bottom">
      ...
      <div class="col-sm-3 offset-sm-2 col-lg-3 offset-lg-0 mb-7 mb-lg-0">
        ...
        <div class="col-sm-3 col-lg-3 mb-7 mb-sm-0">
          <!-- Figures -->
          <div class="text-center">
            <img src="img/SISNOVA.svg" width="200px">
          </div>
          <!-- End Figures -->
        </div>
...
$(document).ready(function(){
    ...
    $(".addMore").click(function(){
        if($('body').find('.fieldGroup').length < maxGroup){
            var fieldHTML = '<div class="row fieldGroup added-form-rom">'+$(".fieldGroupCopy").html()+'</div>';
            $('body').find('.fieldGroup:last').after(fieldHTML);
        }else{
            alert('Maximo '+maxGroup+' cotizaciones.');
        }
    });
